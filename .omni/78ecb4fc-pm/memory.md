...
- 2026-08-21 prototype 桌機版 layout 已由置中雙欄改為寬版三欄：`.omni/demo_template_latest.html` 新增 `ctm-demo-shell` 三欄 grid（左敘事 430px／手機 392px／右側評審速讀 350px）、右欄集中 B2B 入口與狀態速讀；重包 `demo/index.html` 並同步 offline zip，manifest 日期 2026-08-21。Browser MCP 仍因 temp profile 權限錯誤無法截圖，需以靜態檢查或 Cloudflare preview 補視覺驗證。
...
---
_Last system refresh: 2026-08-21 08:26 UTC_
